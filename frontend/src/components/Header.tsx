...
const Header = () => {
  ...
  return (
    <div className='flex flex-col justify-between items-center my-20'>
      ...
      <h1  className='text-4xl font-semibold max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center drop-shadow-md'> Transform Your Look<span className='text-blue-500'>Look</span>,with AI-Powered Hairstyles</h1>
